...
final class MusicNetworkingURLMockTests: XCTestCase {
    ...
    private let resource = Resource<NowPlayingMusicListResponse>.nowPlayingList()
    ...
    func testURLoadingSuccess() {
        ...
        // GIVEN
        var response: NowPlayingMusicListResponse!
        ...
        URLProtocolMock.requestHandler = { _ in
            ...
            return (response, TestHelper.jsonData(forResource: "test_nowplaying_success"))
        }
        ...
        // There should be 2 music play in the array
        XCTAssertEqual(response.playList.count, 2)
    }
